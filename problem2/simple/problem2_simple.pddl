(define (problem emergency_services_logistics_problem2_simple)
    (:domain emergency_services_logistics_domain2_simple)
    ...
    (:objects
        ...
        pos1 pos2 pos3 pos4 - compartment ; FIX THE CAPACITY OF THE ROBOTIC AGENT TO BE 4.
